...
const Footer = () => {
    ...
    return (
        <div>
            <footer className="footer footer-center p-10 bg-[#03203C] text-yellow-50">
                <div>
                    <svg width="50" height="50" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" className="inline-block fill-current"><FontAwesomeIcon icon={faComputer} /> </svg>
